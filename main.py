...
from forms import CreatePostForm, RegisterForm, LoginForm, Comments
import os
...
#     comments = relationship("CommentSection", back_populates="comment_author")
#
...
#     comments = relationship("CommentSection", back_populates="parent_post")
#
# class CommentSection(db.Model):
#     tablename = "commentbox"
#     id = db.Column(db.Integer, primary_key=True)
